...
**[프로젝트 바로가기](https://github.com/JooYoung1121/maple_db)** · 현재 버전: **v3.3.0**
...
| `GEMINI_CHAT_MODEL` | 선택 사항. 디스코드 대화·인터넷 검색 모델. 기본값: `gemini-2.5-flash` |
| `GEMINI_NHIT_MODEL` | 선택 사항. N방컷 AI 분석 모델. 기본값: `gemini-2.5-flash-lite` |
