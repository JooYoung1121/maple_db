...
const SPOTS: Spot[] = [
  ...
  { levelMin: 33, levelMax: 40, map: "사헬지대 3", region: "아랍 (사막)", monsters: ["모래두더쥐", "스콜피언"], tip: "전사 솔플 추천. 카에데보다 지형이 편하고 활공 60% 드롭도 매력.", source: "https://ssalmuk.com/community/hot/detail?code=B25041542", jobs: ["히어로","팔라딘","다크나이트","소울마스터","스트라이커","윈드브레이커"] },
  ...
  { levelMin: 40, levelMax: 50, map: "마가티아 제뉴미스트 연구소 B-3", region: "마가티아", monsters: ["휴로이드"], tip: "40대 마가티아 구간. C구역 진입 전 단계. 야생곰의 영토와 번갈아 활용 권장.", source: "https://gall.dcinside.com/mgallery/board/view/?id=mapleland&no=3680045", common: true },
  ...
  { levelMin: 50, levelMax: 60, map: "오르비스 구름공원 (CD)", region: "오르비스", monsters: ["구름요정", "릴라"], tip: "화독법(화염 광역)으로 시간당 40~45만. 플레임위자드·불독에 특히 좋다.", source: "https://vortexgaming.io/en/postdetail/543979", jobs: ["플레임위자드","불독"] },
  ...
  { levelMin: 65, levelMax: 75, map: "차가운 요람 (미니던전)", region: "엘나스 산맥 (엘리니아 방면)", monsters: ["다크드레이크"], tip: "엘리니아→택시→개미굴광장→차가운 요람 경로. 다크드레이크(Lv68) 단일 출현. 접근성은 낮지만 드레이크만 나와 인기. 개인화 2시간.", source: "https://vortexgaming.io/postdetail/843653", common: true, miniDungeon: true },
  ...
  { levelMin: 80, levelMax: 100, map: "듀얼 파이렛 파티 (듀파)", region: "루디브리엄 시계탑 최하층", monsters: ["듀얼 파이렛", "듀얼파라곤"], tip: "파티에 끼면 80~100 레벨업이 획기적으로 빠르다. 85~98 마법사 범위 파밍 성지(뇌전수리검 드롭). 섀도어는 메소익스플로전 사냥터(5번 자리 적자 덜함).", source: "https://arca.live/b/mapleland/146599129", jobs: ["히어로","팔라딘","다크나이트","썬콜","불독","비숍","섀도어","나이트로드"] },
  ...
  { levelMin: 83, levelMax: 100, map: "붉은 켄타우로스 / 숲속 갈가마귀", region: "미나르 숲", monsters: ["붉은 켄타우로스", "갈가마귀"], tip: "85~100 붉켄 1순위·숲갈 2순위. 광역몹 밀집맵이라 원거리·관통에 적합. 붉켄은 얼음 약점이라 썬콜 효율 최고.", source: "https://vortexgaming.io/postdetail/521809", jobs: ["보우마스터","신궁","썬콜"] },
  ...
  // ── 100~120+ ──
  { levelMin: 92, levelMax: 120, map: "오징어배 (위험한 바다 협곡 2)", region: "아쿠아로드 해저", monsters: ["샤프 오징어", "오징어"], tip: "도적 핵심. 몹이 흩어져 단일기로 한 마리씩 컷(광역 금지). 2층 1자컷이 표창도적 최적, 5층은 나로 스공 2400+ 요구. 파티 전원 메소업이라 샾비 내고도 흑자, 듀파보다 효율 우위.", source: "https://gall.dcinside.com/mgallery/board/view/?id=mapleland&no=2377322", jobs: ["보우마스터","신궁","나이트로드","섀도어"] },
  { levelMin: 100, levelMax: 120, map: "사잇길 우1~우3", region: "오르비스~엘나스 사잇길", monsters: ["레드 와이번", "다크 와이번"], tip: "100+ 도적 솔플/소수팟. 흑자는 미미해 장공 파밍 목적에 가깝다. 물약 여유 있으면 붉켄으로 넘어가는 게 경험치 효율상 유리.", source: "https://arca.live/b/mapleland/146640057", jobs: ["나이트로드","섀도어"] },
  ...
  { levelMin: 100, levelMax: 120, map: "불의 전당 3층 5인 / 만타가오리 동굴", region: "엘나스 / 아쿠아리움", monsters: ["파이어브랜드", "만타가오리"], tip: "100~108 불어전 5인 3층, 105+ 만타동굴 캐리. 시그너스 만렙(120)까지 이어지는 고렙 공통 루트.", source: "https://vortexgaming.io/postdetail/568189", common: true },
  ...
  // ── 💰 메소 파밍 ──
  { levelMin: 71, levelMax: 90, map: "구름 공원 6 (906)", region: "오르비스", monsters: ["러스트 픽시", "루나 픽시"], tip: "대표 순메소 파밍지. 태양의 흔적 시간당 2300~2600개 환금, 71렙 봉황4작 기준 시간당 90~110만 메소 + 금/사파이어/장비. 몹이 촘촘해 원거리 직업이 포션 절약 유리.", source: "https://gall.dcinside.com/mgallery/board/view/?id=mapleland&no=1716620", common: true, kind: "meso" },
  ...
  { levelMin: 60, levelMax: 80, map: "주니어 발록", region: "슬리피우드 저주받은 신전", monsters: ["주니어 발록"], tip: "보스 66렙. 강한 마법공격으로 머쉬맘보다 난이도 높음. 중급 입문/도전용.", source: "https://maple.inven.co.kr/dataninfo/monster/detail.php?code=8130100", common: true, kind: "boss" },
  ...
  { levelMin: 100, levelMax: 130, map: "크림슨 발록", region: "발록의 배 (오르비스↔리스항구)", monsters: ["크림슨 발록"], tip: "보스 100렙. 입문보다 중상급 도전 단계, 강한 마공 보유.", source: "https://maple.inven.co.kr/dataninfo/monster/detail.php?code=8150000", common: true, kind: "boss" },
];
