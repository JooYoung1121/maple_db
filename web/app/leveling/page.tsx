...
const SPOTS: Spot[] = [
  ...
  { levelMin: 54, levelMax: 80, map: "골렘의 숲 (골숲)", region: "슬리피우드 히든스트리트", monsters: ["스톤골렘", "다크 스톤골렘", "미스릴 뮤테"], tip: "젠률이 엄청나 솔플·파티 모두 좋고 드롭 가치도 높다. 바닥 분할 파티 가능. 근접 광역에 특히 적합.", source: "https://vortexgaming.io/en/postdetail/498457", jobs: ["히어로","팔라딘","다크나이트","썬콜","불독","비숍","소울마스터","스트라이커","바이퍼"] },
  ...
  { levelMin: 73, levelMax: 90, map: "시간의 신전 (사이길)", region: "시간의 신전", monsters: ["도도", "릴리노흐", "라이카"], tip: "73렙부터 진입. 장갑 공격력 드롭. 원거리 단일/관통이 안정적. ※ 2.0 신규 지역이라 입장 조건이 바뀔 수 있음.", source: "https://vortexgaming.io/postdetail/568189", jobs: ["보우마스터","신궁"] },
  ...
  { levelMin: 80, levelMax: 85, map: "하늘 둥지 입구 (하둥)", region: "오르비스", monsters: ["하프", "블러드하프"], tip: "익스플로전(불독)·체인라이트닝(썬콜) 필요 → 75~77 정법 전환 권장. 경험치 120만+. 비숍 1확은 합마 920 요구.", source: "https://namu.wiki/w/Mapleland/직업/비숍", jobs: ["썬콜","불독","비숍"] },
  ...
  { levelMin: 89, levelMax: 100, map: "사헬지대 (90제 파밍)", region: "니할 사막", monsters: ["블루 드래곤터틀"], tip: "90제·100제 장비가 드롭. 표창/단검 도적이 파밍 겸 사냥.", source: "https://namu.wiki/w/Mapleland/직업/섀도어", jobs: ["나이트로드","섀도어"] },
