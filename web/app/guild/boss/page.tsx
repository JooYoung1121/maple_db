...
const BOSSES: BossInfo[] = [
  ...
  { name: "마왕 발록", cooldownHours: 24, maxTry: 7, cooldownType: "shared", note: "하루 7회 입장 (원정대) — 1트 시작 기준 24시간 리셋 가정, 실측 다르면 제보", timeLabel: "1트 시작 시각" },
  { name: "카오스 자쿰", cooldownHours: 168, maxTry: 2, cooldownType: "shared", note: "주 2회 입장 — 1트 시작 기준 주간 쿨 가정, 실측 다르면 제보", timeLabel: "1트 시작 시각" },
];
