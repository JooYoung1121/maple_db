    ...
    branches: [
      {
        ...
        advancements: [
          ...
          },
          {
            ...
            npc: "헨리테 (전직관)", location: "에델슈타인 - 레지스탕스 본부",
            quest: "'나를 넘어서는 너' (원본 기준) — 전직 비용 1,000만 메소 납부 (9/7 커뮤니티 실측 교차 확인)",
            skills: ["피니쉬 블로우", "어드밴스드 다크 오라", "어드밴스드 옐로우 오라", "싸이클론", "다크 제네시스", "스탠스", "쉘터", "에너자이즈"],
            tip: "마스터리북: 스탠스 20/30은 기존 전사 마북 공유. 어드 다크오라 20(라이카·파풀라투스)·다크 제네시스 30(망각의 수호병)·싸이클론 30(후회의 수호대장)·쉘터 20(망각의 사제) 몬스터북 확인 — 상세는 배틀메이지 가이드 참고",
          },
        ],
      },
    ],
