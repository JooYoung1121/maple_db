...
export const BATTLE_MAGE_FIELD_NOTES: { title: string; body: string; source: string }[] = [
  ...
  {
    title: "몹 실측 스탯 반영",
    body: "라키~광석 이터 구간의 경험치는 커뮤니티 실측(본섭 환산)으로 갱신 완료 — 기존 GMS 참고값의 약 2.3배. 광석 이터는 몬스터북 기준 HP 57,000·MP 250. 나머지 몹의 HP는 아직 GMS 참고값.",
    source: "https://gall.dcinside.com/mgallery/board/view/?id=mapleland&no=3943694",
  },
  {
    title: "광석 이터 위치·평가",
    body: "광산 최심부(갱도 연작 끝, 겔리메르 연구소 방면)에서 확인. 한 맵에 10마리 이상 고밀도 젠이지만 지형상 솔로/1:1 쩔에 적합하고 파티 사냥용 젠량은 부족하다는 평. 배메 마북은 드롭하지 않음(몬스터북 실측).",
    source: "https://gall.dcinside.com/mgallery/board/view/?id=mapleland&no=3944293",
  },
  {
    title: "오라 활용 실측",
    body: "오라는 범위 상시 적용형이라 쩔·파티사냥 시너지가 없다는 실측. 대신 보스 파티에서는 어드밴스드 다크 오라(파티 데미지 +20%) 가치가 높다는 평. 서로 다른 배메의 오라는 중첩 가능.",
