...
export const SITE_SECTIONS: SiteSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/hp-exp", label: "체경비 사냥터", icon: "🩸", description: "체력 대비 경험치로 찾는 꿀 사냥터 — 맵별 마릿수·분포 기반", keywords: ["체경비", "체경", "효율", "꿀몹", "꿀맵", "가성비"] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/highlow", label: "메랜 하이로우", icon: "📈", description: "레벨·HP·EXP 높낮이 연승" },
      { href: "/map-guess", label: "미니맵 어디게?", icon: "🗺️", description: "미니맵 모양으로 장소 추리" },
      { href: "/drop-chain", label: "드랍 연결 퍼즐", icon: "🔗", description: "몬스터·드랍템·사냥터 연결" },
