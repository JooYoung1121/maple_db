...
export const CHANGELOG: ChangelogEntry[] = [
    ...
    features: [
      {
        ...
        items: [
          ...
          "일러스트 배경 9종(다크 판타지·용암 성채·황금 신전·초록 숲·얼음 성채·독안개·달빛 뒷골목·해적선·청록 파도) + 그래픽 배경 4종, 직업 일러스트 프리셋 13종·게임 스프라이트 프리셋 12종(자쿰 투구+리버스), 스탯 직접 입력 모드",
          "이미지 합성은 전부 브라우저에서 처리 — 업로드 이미지가 서버로 전송되지 않음",
          "AI 치비 일러스트 변환(베타) — 캐릭터 캡쳐를 일러스트로 변환, 디스코드 로그인 유저 월 2회",
          "배경 템플릿 3종(번개·단풍·밤하늘) + 프리셋 일러스트 배경 확장 구조(다크나이트·픽셀 파스텔 등 순차 추가), 구직/구인 모드, PNG 저장",
        ],
      },
      {
        category: "드랍률 후속 정정",
  ...
  },
  {
    ...
    date: "2026-09-18",
    type: "minor",
    title: "퀘스트 스페셜리스트 가이드",
    pages: ["/quest-specialist"],
    features: [
      {
        category: "퀘스트 스페셜리스트",
        items: [
          "퀘스트 800개 훈장(달리어 칭호 도전) 전용 가이드 신설 — 옵션·조건은 WZ 데이터 기준",
          "레벨 구간을 지나치면 못 깨는 퀘스트 22묶음 정리 — 완주자 실측 인증글 기반",
          "전달형(준비물만 사두면 즉시 완료)·처치형(사냥 동선 배치) 탭 분리 — 레벨 필터와 준비물·처치 수량표 제공",
          "연계 퀘스트 100묶음의 준비물·처치 수 총량 합산 — 체인 전체를 끊김 없이 완주하는 장보기 목록",
          "몹 시너지 — 같은 몬스터를 요구하는 퀘스트 묶음으로 사냥 동선 효율화",
          "네펜데스 나팔찌·해독된 통신문 히든 등 알려진 함정과 남은 장벽(발록 200회·핑크빈 퀘) 안내",
        ],
      },
    ],
  },
    ...
    features: [
      {
        ...
        items: [
          ...
          "메이플랜드 구조상 클리어 가능성 분석 — 데미지 공식·캐시 물량 강제·운영 밸런스 3개 시나리오, 오크통(1바이퍼) 무의미 여부 포함",
          "총 16마리 처치 순서(솔로몬 5·렉스 4·휘긴 3·무닌 2·아리엘 1), 본체 투명 파워업·반사 20초+40초 등 실측 기반 패턴 반영",
          "빅뱅 전 '깨지 말라고 낸 보스' 역사(본체 미구현 튕김·핵 격파·스카니아 최초 격파)와 9/9 차단→9/18 오픈 타임라인",
          "9/18 패치노트 반영 — 메랜 본섭 확정: 원정대 3인 이상·140레벨·7일 최대 2회, 발판 길이/위치 조정·마법 구체 판정 10% 축소 등 원본 대비 완화판 출시",
          "데이터 판본 주의(빅뱅 전 KMST 기준) 명시 — 드롭 구성(리버스 생드랍·타임리스 제작)·실제 클리어 여부는 오픈 후 실측으로 확정 예정",
        ],
      },
    ],
  },
  {
    ...
    date: "2026-09-14",
    type: "minor",
    title: "직업별 장비 도감 · 스킬 획득 퀘스트 · 검색 개선",
    pages: ["/items", "/skill-quests", "/skills", "/quests", "/mobs", "/maps", "/npcs"],
    features: [
      {
        category: "직업별 장비 도감",
        items: [
          "직업·착용 레벨·부위별 장비를 레벨순으로 탐색하고 기본 옵션과 드롭 몬스터를 카드에서 확인",
          "공용 장비를 기본 포함하고 전용 장비만 보기 제공 — 목걸이는 장신구로 분류",
          "부보안관 은뱃지·나리케인의 징표·크림슨우드 교환 뱃지 4종의 한글명·별칭 검색과 획득 안내 추가",
          "나리케인의 징표에 공식 옵션 변경 반영 — 공격력 4·마력 8·HP/MP 150. 카오스 자쿰 투구는 기본값과 미확인 획득 편차를 구분",
        ],
      },
      {
        category: "스킬 획득 가이드",
        items: [
          "모험가 4차 중심의 가이드 47개 — 직업·획득 방식·스킬명·NPC·재료로 검색",
          "선행 퀘스트, 준비물, 진행 순서, 파티 조건, 스킬북과 상한 확장을 구분하고 기존 퀘스트·아이템 DB 연결",
          "기분안기모띠 원작 공략의 직업·보상 오기를 대조하고 변신의 비약 재료 등 확인된 공식 변경점과 출처 표시",
          "시그너스·배틀메이지의 일부 세부 조건과 장비 편차는 추가 검증 대상으로 안내",
        ],
      },
      {
        category: "검색과 필터",
        items: [
          "드롭다운 중심 필터를 버튼 선택지·레벨 구간·적용 조건 표시로 개선하고 초기화·URL 공유·뒤로가기 지원",
          "몬스터 일반/보스, NPC 상점, 맵 지역/마을 분류와 페이지 이동 개선",
          "통합검색·자동완성에 현행 한글명 우선 표시, 띄어쓰기·중간 문자열 검색 및 검색 결과 페이지 처리 보완",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    features: [
      ...
      {
        category: "아이템 시세 (신규 개방)",
        items: [
          "비공개였던 /market을 시세 조회 페이지로 개방 — 아이템 2,500여 종 검색, 팝니다/삽니다 · 일/주/월봉 추이 차트와 매물 수, 최저~최고가 표",
          "matip.kr 매물 집계(5분 캐시 프록시) 기반 — 찰리중사 교환 계산과 동일한 시세 소스",
        ],
      },
      {
        category: "가이드 갱신",
        items: [
          "카오스 자쿰 공략에 '파츠별 패턴 · 타이밍' 섹션 추가 (커뮤니티 실측 — 벞해팔 좌4·우4, 단체유혹 규칙, 몸통 벞해 페이즈별 타이밍) — 라이브 공략글 반영 완료",
          "훈장 가이드: 소공의 후계자 획득 기간 종료(9/11) 표기",
          "이상형 월드컵 아이템 모드: 대결 카드에 핵심 스탯·거래소 시세 나란히 표시",
        ],
      },
      {
        category: "유물창고",
        items: [
          "역할을 다한 페이지를 모아두는 '유물창고' 메뉴 섹션 신설 — 테스피아 2.0 보스 미리보기를 놀이터에서 이관 (기존 유물 배너 체계와 통합)",
        ],
      },
      {
        category: "체경비 사냥터 개선",
        items: [
          "체경비 동률이면 마릿수 많은 맵 우선 정렬 — 1~2마리 맵이 상위를 도배하던 문제 해결",
          "최소 마릿수 필터 추가 (기본 3마리+, 전체/6/10 선택)",
          "마릿수 미상(구조물 젠) 맵에도 층수·폭 지형 정보 표시",
        ],
      },
    ],
  },
  {
    ...
    date: "2026-09-10",
    type: "minor",
    title: "체경비 사냥터 — 맵별 마릿수·분포 기반 추천",
    pages: ["/hp-exp", "/maps"],
    features: [
      {
        category: "체경비 사냥터 (신규)",
        items: [
          "체경비(몹 체력 ÷ 경험치) 기준 몹 랭킹 + 맵 추천 페이지 — 내 레벨 기준 몹 범위 조절, 체경비순/한 젠 경험치순 정렬",
          "맵 카드에 몹별 마릿수·총 젠 수·한 젠 경험치·지형(층수/폭) 표시 — 스폰 배치 데이터 기반",
          "망둥이처럼 구조물에서 젠되는 몹은 마릿수 미상으로 서식지 표기 (마을 맵 제외)",
          "에델슈타인·아모리안 챌린지 등 신지역 맵 상세(스폰·미니맵) 79종 수집 — 맵 상세 페이지에도 반영",
        ],
      },
      {
        category: "에델슈타인 드랍테이블 (1차)",
        items: [
          "커뮤니티 실측(몬스터북·툴팁 스크린샷 판독)으로 몹 6종 드랍 36건 등록 — 경비로봇L·라칸(펫장비 점프 60%), 강화된 방어 시스템, AF형·고장난 DF형 안드로이드(장비 11종·주문서·원석), 광석 이터(암살 30·어드 호밍 20 마북, 교환불가 파워 엘릭서)",
          "나머지 저레벨 몹 등 17종은 커뮤니티 제보가 아직 없어 미기입 — 제보 축적 후 갱신",
        ],
      },
    ],
  },
  {
    ...
    date: "2026-09-08",
    type: "minor",
    title: "웨딩 파퀘 도우미 · 사이트 점검 개선",
    pages: ["/pq/amorian-solver", "/pq", "/wedding", "/playground", "/play", "/battle-mage", "/quests", "/skills", "/events", "/performance"],
    features: [
      {
        category: "정확성 · 데이터 신뢰",
        items: [
          "놀이터 저장 실패 시 재시도, 주사위 공동 1위·중복 닉네임 방지·다크 모드 눈 색 수정",
          "켄타 카운터 일 10회 적용, 오늘의 몬스터 정답·힌트를 날짜별 고정해 데이터 업데이트 중 변경 방지",
          "나이트로드 스킬 오분류 정리와 기존 상세 링크 보존, 배메 최신 효과와 원작 레벨 표 분리",
          "마야 퀘스트 재료명 복구, 미확인 퀘스트 보상 표시, 에델 몹의 환산 EXP·추정 HP·원작 출현 맵 근거 구별",
          "수정된 고정 공지를 주간 뉴스 원자료에 별도 포함, 크롤러 실행·성공·0건/실패 진단 추가",
        ],
      },
      {
        category: "가독성 · 개인 도구",
        items: [
          "아모리안 6시간 재입장 기록·탭 내 알림, 개인 배메 마북 체크리스트·획득 경로 연결",
          "놀이터 허브와 최근 플레이·오늘 완료 표시, 에델슈타인 이름 퀴즈 테마",
          "9/8 16:30 무중단 배포의 배메 퀘스트·블러드 드레인·오라 수정 안내, 소공의 후계자 종료 일정과 홈 마감 이벤트 연결",
          "모바일 홈 밀도·작은 안내 글씨·퀘스트 대비·필터 레이블·표 키보드 접근성 개선",
          "비대화형 린트와 DB 준비 상태 확인, 선택형 로컬 반응성 진단(INP; 서버 전송 없음)",
        ],
      },
      {
        category: "아모리안 챌린지",
  ...
  },
  {
    ...
    date: "2026-09-08",
    type: "minor",
    title: "9/7 패치 확정 데이터·커뮤니티 실측 반영",
    pages: ["/battle-mage", "/mobs", "/skills", "/leveling", "/events"],
    features: [
      {
        category: "실측 (9/7~9/8 커뮤니티)",
        items: [
          "배메 마스터리북 아이템 11권 등록 + 몬스터북 확인 드롭 6건 반영 — 어드 다크오라 20(라이카·파풀라투스 70%), 어드 옐로우오라 30(망각의 수호대장), 다크 제네시스 30(망각의 수호병), 싸이클론 30(후회의 수호대장), 쉘터 20(망각의 사제)",
          "에델 몹 실측 스탯 — 라키~광석 이터 경험치 9종(본섭 환산, GMS 참고값의 약 2.3배), 광석 이터 HP 57,000·MP 250(몬스터북), 라키 HP 15,000",
          "배틀메이지 가이드에 '출시 후 실측 메모' 섹션 — 에델 가는 법, 4차 전직 1,000만 메소, 에델 퀘스트 71개 실측, 광석 이터 위치, 오라 활용",
          "아모리아의 벚꽃 정원 퀘스트 등록 (Lv.35+, 정원사 제이콥 — 퀘스트창 스크린샷 판독)",
          "배틀메이지 성장 지원 이벤트(9/7~10/30) 정리본을 이벤트 아카이브에 등록",
        ],
      },
      {
        category: "배틀메이지",
        items: [
          "9/7 패치노트 당일 수정본의 밸런스 조정 전문 반영 — 블로우류 자동 발동화(트리플 20×3·쿼드 28×4·데스 42×5·피니쉬 60×6), 싸이클론 850·재사용 2분, 스탠스 95%, 쉘터 10분, 컨버전·리바이브·부스터 지속시간 등 19건",
          "배틀메이지 가이드에 '9/7 밸런스 조정(원작 대비)' 비교표 섹션 추가",
          "스킬 DB 설명에 [메이플랜드 9/7 조정] 병기 (레벨별 수치는 KMST 참고값 유지)",
        ],
      },
      {
        category: "게임 데이터",
        items: [
          "에델슈타인 몬스터 7종 레벨을 9/7 공지 확정값으로 수정 — 순찰로봇 15·이상한 이정표 17·구렁이 19·안전제일 30·경비로봇L 78·라칸 83·고장난 DF형 안드로이드 95",
          "버커니어 에너지 차지(무조건 중첩)·캡틴 배틀쉽(이동속도 110) 조정 반영",
          "시드 동기화 개선 — skills 테이블 통째 교체 전환, 몹 스탯 컬럼 시드 기준 갱신(관리자 수정 컬럼은 보존)",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    date: "2026-09-04",
    type: "minor",
    title: "메이커 아이템 강화 시뮬레이터 · 보스 타이머 단축키 토글",
    pages: ["/maker", "/boss-timer"],
    features: [
      {
        category: "메이커",
        items: [
          "아이템 강화 시뮬레이터 신설 — 장비를 검색해 좌측 정보 카드 + 우측 순번(① 메이커 제작 → ② 아이템 옵션 → ③ 주문서 강화 → ④ 성장 → ⑤ 사용 내역)으로 강화·제작·성장을 한 화면에서 시뮬",
          "메이커 제작: 보석 3슬롯 + 촉진제(편차 하옵 차단·10% 파괴) · 아이템 옵션 편차 롤(정옵/상옵/하옵)",
          "주문서 강화: 계열별 실제 주문서 이미지·성공/실패 슬롯, 성장: 리버스·타임리스 레벨업 3회 시뮬 (실측 성장표)",
          "사용 내역: 제작 재료(오리할콘·시간의 조각 등)·주문서 개수 정리 + 단가 입력 시 총 메소 계산 — 최종 스탯이 몇이 되는지 좌측 카드에 실시간 표시",
          "아이템 등급(품질) 색상 반영 — 강화 성공 수만큼 (+N) 표기, 순정 대비 증가분 합에 따라 중품·상품·최상품·프리미엄/엑셀런트/스페셜 클래스 색상, 성공/실패·주문서 내역 요약",
          "강화 시뮬은 리버스·타임리스 장비만 검색 노출 (주문서 계산기 등 다른 도구는 전 아이템 그대로) · 클로(리버스 람피온) 성장 대상 복구",
          "⑥ 행동 로그 추가 — 제작·주문서 성공/실패·레벨업 성장 내역이 시각순으로 기록",
          "강화 명예의전당 — 강화 결과를 닉네임과 함께 등록해 등급(증가분)순 갤러리에서 겨루고, 공유 링크(?showcase=)로 남에게 자랑",
        ],
      },
      {
        category: "보스 타이머",
        items: [
          "키보드 단축키를 시작↔정지 토글로 변경 — 한 번 누르면 시작, 다시 누르면 정지 (재시작은 Shift+키)",
          "사망 복귀 타이머를 15분 → 14분(마을 복귀 실측)으로 수정, 카쿰 사망 섹션도 동일 적용",
          "카쿰 버프해제 표기 정정 — 2페 버프해제 시작을 근거 없는 'HP 50%'에서 공략글 기준 '2페 진입 후 2분 간격'으로 수정",
        ],
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        category: "네비게이션",
        items: [
          "가이드 그룹(15개)을 둘로 분리 — 성장·생활은 \"가이드\", 혼테일·보스 타이머·필드보스·무릉도장·길드대항전은 새 \"보스 · 원정대\" 그룹으로",
        ],
      },
      {
        category: "검색",
        items: [
          "통합검색 자동완성에 기능 · 가이드 바로가기 — \"카쿰\", \"무릉\", \"결혼\"처럼 검색하면 해당 페이지로 바로 이동 (줄임말 별칭 지원: 파퀘·필보 등)",
          "정보공유 게시판 글도 통합검색에 노출 — 카오스 자쿰 공략 등 게시판 공략글을 검색으로 진입",
      ...
      },
      {
        category: "보스 타이머",
        items: [
          "카오스 자쿰 타이머 추가 — 단체유혹(첫/다음)·버프해제(2·3페)·공무·위협·리저렉션/직업 스킬·사망 프리셋, 상단 탭으로 혼테일과 전환 (수치 근거: 메랜 커뮤니티 실측 공략)",
          "반복 타이머(🔁) — 위협·벞해·유혹처럼 주기 패턴은 만료 시 자동 재시작하며 매 회차 알림, 공유 방에서도 동기화",
          "음성 알림(TTS) — 종료 10초 전 \"OO 10초 전\" 음성 안내 (켜고 끌 수 있음)",
          "PIP 미니 타이머(📌) — 실행 중 타이머를 게임 화면 위 항상 떠 있는 작은 창으로 (데스크톱 크롬/엣지)",
          "카드에 남은 시간 진행바 표시 · 사용법 문구의 기본값 표기 정정 (인레이지 8분·공무 43초)",
        ],
      },
      {
        category: "공략",
        items: [
          "혼테일 공략: 중머리 버프해제 시작 시점 표기를 패턴 표와 통일 (50% → 60%)",
          "카오스 자쿰 공략(길드 정보공유)에 파츠별 패턴·타이밍 정리 섹션 추가 준비 — 좌4·우4팔 벞해, 좌2팔 단유, 몸통 페이즈별 벞해·단유 주기",
        ],
      },
    ],
  },
  {
    ...
    date: "2026-09-02",
    type: "minor",
    title: "해적 마스터리북 검색 복구 · 띄어쓰기 무시 검색",
    pages: ["/", "/drop-search", "/items"],
    features: [
      {
        category: "데이터",
        items: [
          "해적 4차 마스터리북 23종·스킬북 7종이 검색·아이템 목록·획득 경로·몹 드랍에 노출되도록 레퍼런스 등록 (드래곤 스트라이크 등 2.0 해적 콘텐츠 누락 복구)",
          "자쿰·혼테일·피아누스 마스터리북의 복제된 드랍률(34.88%)과 0.00% 표기 204건을 확률 미상으로 정리",
        ],
      },
      {
        category: "검색",
        items: [
          "띄어쓰기가 달라도 검색됨 — \"드래곤스트라이크\"로도 \"드래곤 스트라이크\" 마스터리북을 찾음",
          "여러 단어 검색 시 단어별 매칭 — \"자쿰 투구\"로 \"자쿰의 투구\" 검색 가능 (통합검색·아이템 목록·획득 경로 공통)",
          "획득 경로 페이지: 결과가 없을 때 안내 문구 표시, 예시 검색어를 실제 아이템명으로 교체",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    date: "2026-08-27",
    type: "minor",
    title: "길드대항전 — 드랍테이블 탭 + 정산기 아이템 드롭다운",
    pages: ["/guild-war"],
    features: [
      {
        category: "길드대항전",
        items: [
          "드랍테이블 탭 추가 — 보너스 상자 42종 전체(마스터리북 13종·60% 주문서 23종·소비 6종) 상자당 확률 · 판당 기대치, 보스 드랍 정리 (디시 메랜갤 리액터 집계 기반)",
          "분배 정산기 드랍 입력을 직접 입력 → 드롭다운 선택으로 교체 (주문서/마북/보스 그룹, 약어 hover 시 풀네임, 목록에 없는 아이템은 직접 입력 지원)",
          "시세표에 약어 풀네임 병기, 공략 가이드 마북 확률을 리액터 집계 기준으로 교정 (속강30 = 캡틴 속성강화 · 폭시20 = 폭풍의 시 확인)",
        ],
      },
    ],
  },
  {
    ...
    date: "2026-08-27",
    type: "minor",
    title: "길드대항전 — 공략 · 상자 배분 · 제물 솔버 · 분배 정산",
    pages: ["/guild-war"],
    features: [
      {
        category: "길드대항전",
        items: [
          "샤레니안 길드퀘스트 공략 가이드 — 입장 조건 · 스테이지별 진행 순서 · 에레고스 보스 · 마스터리북 보상 정리",
          "보너스 상자 담당 구역 배분도 — 4~7인 인원수별 구역 이미지",
          "제물 맞추기(야구게임) 솔버 — 올바른/틀린 개수만 입력하면 다음 배치를 자동 추천 (되돌리기 지원)",
          "분배금 정산기 — 트라이별 참여 체크 + 드랍 아이템 + 시세 입력으로 수수료(판매 5% · 송금 5%) 반영 송금액 자동 계산, 정산 결과 복사",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    date: "2026-08-20",
    type: "minor",
    title: "사이트 전반 점검 — 사냥터 데이터 통합·버닝 토글·HWP 첨부·메뉴 재편",
    pages: ["/hunt", "/leveling", "/guild/info"],
    features: [
      {
        category: "사냥터",
        items: [
          "사냥터 추천과 직업별 육성 사냥터의 데이터를 한 파일로 통합해 앞으로 두 페이지가 함께 갱신되도록 정리",
          "사냥터 추천에 버닝 월드 토글 추가 — Lv.120 미만 경험치 1.5배가 시간당 경험치에 반영되고, 버닝 종료 후엔 자동으로 본섭 기준 표시",
          "직업별 육성 사냥터에 시간의 신전 3구역(기억 Lv.90~110 · 후회 Lv.105~120 · 망각 Lv.120~140) 추가",
          "파티퀘스트 카드에서 보상·효율 비교 페이지로 바로가기 제공",
        ],
      },
      {
        category: "길드 정보공유",
        items: [
          "표 첨부에 엑셀(.xlsx) 외 한글(.hwp) 파일 지원 — 표 구조·병합·텍스트를 표 뷰로 변환 (HWPX는 준비 중)",
        ],
      },
      {
        category: "메뉴 정리",
        items: [
          "시뮬레이터 그룹 신설(스킬 시뮬 · 장비 세팅 · 코디), 메이커를 계산기로 이동, 테스피아 아카이브를 놀이터로 이동해 메뉴 그룹을 10개에서 8개로 정리",
        ],
      },
      {
        category: "내부 정리",
        items: [
          "초기 구축기에 쓰던 일회성 스크립트와 미사용 파일·엔드포인트 정리 (동작 변화 없음)",
        ],
      },
    ],
  },
    ...
    features: [
      {
        category: "결혼",
        items: [
          "반지 4종을 메랜 공식 안내 기준으로 정정 — 문스톤링·샤이닝스타링·골드하트링·실버윙링 (캐럿별 올스탯 +1/+2/+3 + 고유 옵션)",
          "약혼반지 제작 재료표 추가 — 기본 재료(달의 돌·별의 돌·금괴·은괴) + 다이아몬드 2/4/6개(=캐럿), 제작비 — 재료는 아이콘 클릭으로 드랍처·시세 연동",
  ...
  },
  {
    ...
    date: "2026-08-13",
    type: "minor",
    title: "결혼 시스템 사전 가이드 + 무릉 하루 제한 반영",
    pages: ["/wedding", "/dojo"],
    features: [
      {
        category: "결혼 시스템 (8/14 출시)",
        items: [
          "사전 가이드 페이지 신설 — 사랑의 증표 4개 재료표(10개 마을, 커뮤 사전 확인) · 재료 선구매 팁",
          "원작 기준 절차 5단계 · 약혼반지 4종 · 채플 vs 대성당 비교 · 하객 보상(오닉스 애플 공마+100) 정리",
          "원작 참고값과 메랜 확정값을 구분 표기 — 8/14 패치노트 공개 후 확정값으로 갱신 예정",
        ],
      },
      {
        category: "무릉도장",
        items: [
          "하루 제한 실측 반영 — 수련 점수 일일 3,500P 상한 · 입장 10회 제한 (검은 띠까지 최소 5일)",
          "랭킹 상태 갱신 — 8/10 배포됨, 순위 반영 지연 제보 표기",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    date: "2026-08-07",
    type: "minor",
    title: "전체 데이터 원작 대조 — 실서버 교정·판본 구분·공식 스킬",
    pages: ["/differences", "/mobs", "/items", "/maps", "/npcs", "/quests", "/skills"],
    features: [
      {
        category: "전수 대조",
        items: [
          "현행 공개 자료 전 레코드 대조 — 몬스터 749종 레벨·HP, 아이템 3,956종 착용 레벨·직업, 맵 1,082·NPC 826·퀘스트 778종 ID·명칭",
          "v62·v83·GMS92 원본을 함께 대조해 메이플랜드 자체 변경과 초기/후기 원작 판본 차이를 분리",
          "원작 API 파서 오탐 41건과 내부·센티널 몬스터 13건을 실제 차이에서 분리하고 감사 결과를 재생성 가능한 파일로 저장",
        ],
      },
      {
        category: "실서버 데이터 교정",
        items: [
          "교차 확인된 공개 몬스터 14종의 레벨·HP, 아이템 4종의 착용 레벨과 26종의 직업 제한을 서버 시작 시 메이플랜드 값으로 안전하게 덮어쓰기",
          "스텀프·까마귀·불너구리는 원작 전 판본과 다른 메랜 변경, 다크 엑스텀프·엘린숲 몬스터는 초기 원작판 채택으로 구분",
          "아이템·몬스터 상세에 원작 비교 ⓘ와 근거 링크, 맵·NPC·퀘스트 상세에는 실제 대조가 끝난 필드 범위를 표시",
          "KMS·GMS에서 같은 ID가 다른 맵인 139건은 잘못된 GMS 구조·젠·드롭·포탈을 숨기고, NPC 한글명 36건은 현행 자료를 우선 표시",
        ],
      },
      {
        category: "공식 자료",
        items: [
          "6/19 공식 패치의 스킬 변경 51개 규칙을 목록 스킬명에 연결하고 원작과 명시적으로 다른 동작과 판본 재조정을 분리",
          "최대 데미지 199,999, 거래 수수료 5%, 버프 유지 규칙, 마스터리북 거래 제한, 변신 비약 재료, 젠 정책을 중앙 차이 목록에 추가",
          "7/24 공식 엘린숲 파티퀘스트의 시그너스 참여 허용과 경험치 상향을 반영",
        ],
      },
    ],
  },
  {
    ...
    date: "2026-08-07",
    type: "minor",
    title: "무릉도장 실전판 — 38층 점수런·계산기·원작 차이",
    pages: ["/dojo", "/medals", "/differences"],
    features: [
      {
        category: "무릉도장",
        items: [
          "공식 38층 구조를 보스 32단계·휴게실 6층으로 구분하고 구간 제한 시간과 솔로·파티 누적 점수를 전 층에 표시",
          "점수런 우선 종료선인 32층 크림슨 발록 114P와 레비아탄·최상층까지 더 갈 때의 효율 판단 기준 정리",
          "목표 보스·실측 시간·현재 점수·하루 판수를 입력하면 시간당 점수, 검은 띠 필요 판수·시간·일수를 계산하는 도구 추가",
          "첫날 완주 사례와 공식 Discord 모집 흐름을 바탕으로 비숍·HB·샤프·주력 딜러 역할 및 무공의 언데드·공반 대응 정리",
          "검은색 허리띠 실제 능력치, 9월 11일까지 소공의 후계자 훈장, 솔로 랭킹 예고 보상 반영",
        ],
      },
      {
        category: "원작 차이",
        items: [
          "수치·보상 옆 ⓘ 버튼에서 메이플랜드 값, 빅뱅 전 원작 값, 판정 상태, 출처, 검증일을 함께 확인하는 공통 표시 추가",
          "원작 차이 모아보기 페이지 신설 — 검증 완료와 확인 중 항목을 분리하고 무릉도장·탐험가 훈장 차이를 중앙 관리",
          "원작 수행자 훈장을 메이플랜드 보상처럼 보이게 하던 임시 목록을 제거하고 공식 한정 훈장으로 교체",
        ],
      },
    ],
  },
    ...
    features: [
      {
        category: "필드보스 채널",
        items: [
          "채널 그리드를 메이플랜드 채널 선택창 배치(한 줄 6개)로 변경 — 원작(5개×4줄)과 달리 메랜 전용 UI 기준",
  ...
  },
  {
    ...
    date: "2026-08-07",
    type: "minor",
    title: "무릉도장 출시 대응 — 32라운드·준비·보상 공략",
    pages: ["/dojo", "/medals", "/news"],
    features: [
      {
        category: "무릉도장",
        items: [
          "8월 7일 공식 점검 일정과 무릉도장 출시 상태를 원작 참고 정보와 분리해 표시",
          "빅뱅 전 원작 32라운드 보스 순서·구간 타이머·포인트·5층 단위 휴식/저장 방식 정리",
          "소비 아이템 제한·포탈 통과 포인트·에너지 필살기·후반 위험 구간 등 첫 도전 핵심 팁 추가",
          "흰 띠부터 검은 띠까지 누적 포인트·스탯과 수행자 훈장 32종·정복자 조건 정리",
          "메이플랜드 실제 입장 조건·보상·수치가 공개되면 즉시 대조할 실측 확인 목록 제공",
        ],
      },
      {
        category: "훈장",
        items: [
          "기존 7/24 오픈 예정 문구를 8/7 업데이트 상태로 정정하고 무릉도장 공략으로 연결",
          "대표 수행자 훈장의 원작 100회 처치 조건과 메이플랜드 확인 대기 상태를 명확히 표시",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    date: "2026-08-04",
    type: "minor",
    title: "길드 이벤트 모집 — 유저 주최 · 지원 · 룰렛 추첨",
    pages: ["/guild/events"],
    features: [
      {
        category: "이벤트 모집",
        items: [
          "누구나 이벤트를 열 수 있는 모집 보드 신설 — 제목·설명·지원 마감일시·정원(선택)·보상 등록",
          "닉네임으로 지원/취소, 정원 차면 자동 차단, 마감 시간이 지나면 지원 종료",
          "주최자 액션: 조기 마감 · 룰렛 추첨(서버 추첨, 결과 고정) · 클리어 처리 — 결과는 카드에 기록",
          "디스코드 로그인 시 닉네임 자동 · 주최자 권한 자동 인식, 비로그인도 브라우저 저장으로 주최 가능",
          "이벤트 등록·추첨 결과는 디스코드 봇 알림 연동",
        ],
      },
    ],
  },
  {
    ...
    date: "2026-08-03",
    type: "minor",
    title: "몬스터파크 계산기 + 필드보스 채널 트래커",
    pages: ["/events", "/field-boss"],
    features: [
      {
        category: "이벤트 정리",
        items: [
          "몬스터파크 정리 페이지에 '120레벨까지 남은 횟수 계산기' 추가 — 레벨·경험치 입력으로 총 필요 횟수·던전별 횟수·달성 예상일·이벤트 내 달성 가능 여부 계산 (길드원 실측 계산기 이식)",
          "이벤트별 인터랙티브 위젯 구조 도입 — 새 이벤트마다 계산기·도구를 붙일 수 있음",
        ],
      },
      {
        category: "필드보스 채널",
        items: [
          "필드보스 처치 채널·시각 공유 페이지 신설 — 채널 그리드에서 기록하면 모두에게 실시간 공유",
          "젠 주기 알려진 보스는 리젠 카운트다운·곧 젠·젠 추정 색상 표시, 미확정 보스는 경과 시간 표시 + 직접 주기 입력",
          "필드보스 20종 지원 (머쉬맘·좀비머쉬맘·주니어발록·파우스트·그리프·마뇽 등)",
        ],
      },
    ],
  },
  {
    ...
    date: "2026-08-02",
    type: "minor",
    title: "리버스 제작 기대값 + 공식 Discord 커뮤니티 동선",
    pages: ["/maker", "/channels"],
    features: [
      {
        category: "메이커",
        items: [
          "리버스 무기 6종 제작 시뮬레이터 추가 — 촉매 실패·제작 보너스·3회 성장·주문서 7장을 단계별 반영",
          "목표 공격력 도달 확률·기대 비용·N회 중 최고 기대값과 완성 공격력 분포를 확률 계산으로 제공",
          "1~1,000회 일괄 제작과 성장·60%/10% 주문서를 직접 누르는 단계별 체험 지원",
          "윌키 공개 영상·자료의 규칙을 참고해 독립 구현하고, 공식 미공개 실측 확률은 화면에서 조정 가능하도록 표시",
        ],
      },
      {
        category: "채널 · 커뮤니티",
        items: [
          "데이터 분석형 메이플랜드 유튜브 채널 '윌키' 등록 — 최신 영상은 기존 YouTube RSS 수집에 포함",
          "메이플랜드 공식 Discord와 구인·거래 글을 웹에서 확인할 수 있는 외부 서비스 메랜피드 링크 추가",
          "Discord 대화 자동 수집은 로그인·권한·운영 정책 문제로 제외하고 외부 실시간 피드 동선만 제공",
        ],
      },
    ],
  },
  {
    ...
    date: "2026-07-31",
    type: "minor",
    title: "디스코드 봇 인포 · 서버 메모 · 일일 AI 사용량",
    pages: ["/guild/discord"],
    features: [
      {
        category: "푸확 봇 스킬",
        items: [
          "!인포·!도움말·!명령어·!스킬로 봇 기능, 질문 예시, 저장 명령어와 오늘의 AI 사용량을 한눈에 안내",
          "!저장 이름 = 내용으로 서버 공유 메모를 만들고, 자연스러운 질문이나 !기억으로 다시 확인",
          "!수정·!삭제 권한을 작성자와 서버 관리자로 제한하고 메모를 서버별로 분리",
          "공식 사이트·공지·몬스터·아이템 답변을 공유 메모보다 우선해 사용자 입력을 검증된 사실처럼 답하지 않도록 보호",
        ],
      },
      {
        category: "AI 사용량 관리",
        items: [
          "Gemini 자유 대화·인터넷 검색에 1인 30회/일, 서버 100회/일 기본 한도와 답변별 카운터 적용",
          "사이트 DB·공지·날씨·도움말·저장 메모는 AI 요청을 차감하지 않으며 매일 00:00(KST)에 자동 초기화",
          "디스코드 관리 페이지에서 공유 메모 기능과 1인·서버 일일 한도를 직접 조정",
        ],
      },
    ],
  },
    ...
    features: [
      {
        category: "혼테일",
        items: [
          "혼테일 공략 페이지(/horntail) 신설 — 패턴 표(원작 WZ 데이터 검증)·속성·필요 명중률·직업별 준비물·파츠별 딜 위치·유혹 케어·참고 영상",
          "타이머 수치 정정: 공무·마무 43초(지속 40초·쿨 60초, 마무 3개 신설), 버프해제 중머리·좌팔 각 60%↓ 5분/30%↓ 3분, 인레이지 8분, 사망 복귀 14분",
          "유혹 프리셋 추가 — 단체유혹 좌팔·우팔(30%↓ 60초)·개인유혹(3분, 원정대 1번 고정)",
          "잘못 알려진 수치 정정: 와이번 소환 45%(50%X), 머리 속성 반감 없음(공격 속성과 혼동), 디버프는 우팔 담당(우날개X)",
        ],
      },
      {
        category: "퀘스트 로드맵",
    ...
    features: [
      {
        category: "퀘스트",
        items: [
          "출시 예정 '드래곤 라이더 / 하늘을 향해' 연계 6단(레벨 150) 공략 추가 — 리프레 퀘스트 11건 → 17건",
          "단계별 선행·시작/완료 NPC·요구 재료를 정리하고, 정체 2에서 갈라지는 A라인(플라잉)·B라인(드래고니카) 분기를 표기",
          "재료 4종 파밍 루트를 사냥터 스폰 수·드랍률과 함께 안내 (사라진 숲 17마리 코니언 동선 추천)",
          "정보공유 게시판에 연계 전체 공략 글 등재",
        ],
      },
      {
        category: "데이터",
        items: [
          "NPC 마타타·천공의 문·드래곤 라이더와 천공 지역 맵 10종을 메이플랜드 레퍼런스에 등록",
          "드래곤 라이더 확정 드랍 직업별 상자 5종과 연계 재료 3종을 아이템 목록에 노출",
          "연계 재료·상자 11종의 한글 아이템 설명 추가 (기존에는 전부 비어 있었음)",
        ],
      },
    ],
  },
    ...
    features: [
      {
        category: "계산기",
        items: [
          "전사·마법사·궁수·도적·해적 직업과 13개 무기군을 지원하는 스공 계산기 추가",
          "순수/장비 스탯, 메이플 용사, 장비·도핑·스킬 공격력을 구분 입력하고 최종 스탯을 즉시 확인",
          "최소·평균·최대 범위와 공격력 1당 주스탯 환산, 메이플 용사 기여도를 함께 제공",
          "내 메랜 직업·레벨 불러오기, 입력값 자동 저장, 장비 세팅·엔방컷 계산기로 바로 연결",
          "기존 공대 분배 기능을 유물창고에서 계산기 메뉴로 이동하고, 공대 분배 탭이 먼저 열리도록 정리",
        ],
      },
    ],
  },
    ...
    features: [
      {
        category: "브레인",
        items: [
          "사냥터 노드에 ⏱ 성장 예측 — 시간당 EXP·다음 레벨/Lv+5까지 소요 시간·기대 메소(드랍 NPC가 기준, 시세 미반영)",
          "분당 처치 수 슬라이더로 내 사냥 속도에 맞춰 조정 (설정 기억)",
          "노드 선택 시 내 캐릭터까지의 경로 강조(나머지 흐리게), 📕 가지 접기, 팝오버 화면 경계 보정",
          "축소 시 중요 노드(캐릭터·목표·허브·핀)만 라벨 표시 — 복잡한 그래프 정리",
        ],
      },
      {
        category: "커뮤니티",
        items: [
          "주간 메랜 독자 댓글 — 열람은 공개, 작성은 디스코드 로그인 전용 (계정 닉네임·길드 배지 표시, 본인 삭제 가능)",
        ],
      },
    ],
  },
    ...
    features: [
      {
        category: "브레인",
        items: [
          "세부 직업 반영 — 레벨에 맞는 차수(1~4차) 직업 선택 (썬콜·비숍·히어로 등 원작 직업 트리)",
          "캐릭터 닉네임 입력 — 그래프 중심 노드에 닉네임 표시, 공유 URL에 name·sub 파라미터",
          "몹 드랍 전체 노출 — 개수 제한 제거 (마북 포함 모든 드랍템이 가지로)",
          "마스터리북은 책 아이콘 대신 해당 스킬 아이콘으로 표시 (샤프 아이즈 → 샤프 아이즈 스킬 아이콘)",
          "🧰 계산기·시뮬 / 🎮 놀이터 허브 노드 — 사이트 기능들이 그래프에서 바로 연결",
        ],
      },
      {
        category: "계정",
        items: [
          "출석부 길드원 게이트 — 출석 체크는 디스코드 로그인 + 길드 서버 멤버만, 계정당 1일 1회 (열람은 계속 공개)",
          "로그인 유도 배너 — 브레인·코디 자랑하기에 소프트 안내, 게시판 글쓰기 닉네임 자동 입력",
        ],
      },
    ],
  },
    ...
    features: [
      {
        category: "검색·데이터",
        items: [
          "현재 DB와 어긋난 검색 색인을 자동 복구해 오래된 퀘스트 결과의 404 문제 해결",
          "같은 표시명의 실제 ID 변형은 대표 결과로 묶고 변형 수를 표시",
          "아이템 → 드롭 몬스터 → 출현 맵을 잇는 획득 경로 탐색과 무결성 점검 모드 추가",
        ],
      },
      {
        category: "탐색·개인화",
        items: [
          "메뉴와 홈 기능 목록을 하나로 통합하고 누락된 주간 메랜·메이커·정보공유 등을 보강",
          "내 레벨·직업·목표·즐겨찾기·최근 기능을 브라우저에 저장하는 내 메랜 페이지 추가",
          "홈 오늘 뭐 하지 요약과 어디서든 여는 통합 검색(Ctrl/⌘+K 또는 /) 추가",
        ],
      },
      {
        category: "안전·사용성",
        items: [
          "관리자 비밀번호의 URL 노출 제거, 환경 변수 미설정 시 관리자 기능을 자동 잠금 처리",
          "태블릿 메뉴 겹침, 키보드 포커스, 스킵 링크, 색 대비와 모션 감소 설정 개선",
          "중복 퀘스트 베타 페이지를 현재 퀘스트 페이지로 통합",
        ],
      },
    ],
  },
