...
NEW_MOBS = [
    (8800101, "카오스 자쿰"),
    (8800102, "카오스 자쿰"),
    # 마왕 발록 부위 — 2009 원작 공략(다음 카페 OZRC/11390) 실측 HP로 개체 확정:
    # 8830001 HP 2,640,000 = 인게임 명칭 '오른손' / 8830002 HP 3,060,000 = '왼손'
    (8830001, "마왕 발록 오른손"),
    (8830002, "마왕 발록 왼손"),
]
...
SPAWN_LINKS = [
    ...
    ([8830000, 8830001, 8830002], 105100300, "발록의 무덤"),
]
...
def main() -> int:
    ...
    # 몹 한글명 갱신 (마왕 발록 본체·부위)
    kms_updates = [(name, "mob", mid) for mid, name in RENAME_MOBS.items()]
